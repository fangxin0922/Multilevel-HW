...
Here we are looking at both the fixed effect of discrimination on emotional safety and how the relationship between discrimination and emotional safety varies by school ID. We do see variation in the slope for discrimination across the different school IDs. In some cases the slope is negative, while in others it is positive. We can calculate the proportion of the variance explained by including random slopes for discrimination as: 0.009 / (0.009 + 0.759) ≈ 0.012  ≈ 1.12%. The variation in discrimination with regard to emotional safety, as explained by the contextual effect of school ID, is relatively small.
...
Overall, including random effects (slopes and/or intercepts) can allow for us to look at variation at the group or cluster level. 